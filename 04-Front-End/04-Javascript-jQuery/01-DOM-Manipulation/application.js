...
function run_challenges() {
  ...
  //$('#email').val("thomasceccaldi@gmail.com");

  $('#email').attr('value','thomasceccaldi@gmail.com');
  ...
  $('table > tbody').append('<tr><td>15</td><td>Tassin la demi-lune</td><td>0</td></tr>');
  ...
  $('table > thead > tr > th').css("background-color", "#DDF4FF");
